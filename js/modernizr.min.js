window.Modernizr = function(e, t, n) {
        ...
        function u(e, t, n) {
            ...
            return o(t, "string") || o(t, "undefined") ? a(r, t) : (r = (e + " " + k.join(i + " ") + i).split(" "), l(r, t, n))
        }
        ...
        function f() {
            d.input = function(n) {
                ...
                for (var r, o, s, i = 0, a = e.length; a > i; i++) y.setAttribute("type", o = e[i]), r = "text" !== y.type, r && (y.value = b, y.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(o) && y.style.WebkitAppearance !== n ? (h.appendChild(y), s = t.defaultView, r = s.getComputedStyle && "textfield" !== s.getComputedStyle(y, null).WebkitAppearance && 0 !== y.offsetHeight, h.removeChild(y)) : /^(search|tel)$/.test(o) || (r = /^(url|email)$/.test(o) ? y.checkValidity && y.checkValidity() === !1 : y.value != b)), $[e[i]] = !!r;
                return $
        ...
        var A, P, c = "2.8.3",
            ...
            j = function(e, n, i, r) {
                ...
                return o = ["&#173;", '<style id="s', g, '">', e, "</style>"].join(""), u.id = g, (f ? u : c).innerHTML += o, c.appendChild(u), f || (c.style.background = "", c.style.overflow = "hidden", l = h.style.overflow, h.style.overflow = "hidden", h.appendChild(c)), s = n(u, e), f ? u.parentNode.removeChild(u) : (c.parentNode.removeChild(c), h.style.overflow = l), !!s
            },
            O = function(t) {
                var n = e.matchMedia || e.msMatchMedia;
                if (n) return n(t) && n(t).matches || !1;
                var i;
                return j("@media " + t + " { #" + g + " { position: absolute; } }", function(t) {
        ...
        P = o(L, "undefined") || o(L.call, "undefined") ? function(e, t) {
            ...
            return i((e + "-webkit- ".split(" ").join(t + e) + x.join(n + e)).slice(0, -e.length)), s(v.backgroundImage, "gradient")
            ...
            var e = !!u("perspective");
            return e && "webkitPerspective" in h.style && j("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", function(t, n) {
            ...
            var e;
            return j(["#", g, "{font:0/0 a}#", g, ':after{content:"', b, '";visibility:hidden;font:3px/1 a}'].join(""), function(t) {
                e = t.offsetHeight >= 3
            }), e
        }, E.video = function() {
        ...
        for (var R in E) P(E, R) && (A = R.toLowerCase(), d[A] = E[R](), N.push((d[A] ? "" : "no-") + A));
        return d.input || f(), d.addTest = function(e, t) {
                if ("object" == typeof e)
                    for (var i in e) P(e, i) && d.addTest(i, e[i]);
                else {
            ...
            function(e, t) {
                ...
                function o(e, n, i) {
                    ...
                    i || (i = r(n));
                    var o;
                    return o = i.cache[e] ? i.cache[e].cloneNode() : d.test(e) ? (i.cache[e] = i.createElem(e)).cloneNode() : i.createElem(e), !o.canHaveChildren || c.test(e) || o.tagUrn ? o : i.frag.appendChild(o)
                }
                ...
                function l(e) {
                    e || (e = t);
                    var i = r(e);
                    return y.shivCSS && !p && !i.hasCSS && (i.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), v || a(e, i), e
                }
                var p, v, u = "3.7.0",
                    f = e.html5 || {},
                ...
                e.html5 = y, l(t)
            }(this, t), d._version = c, d._prefixes = x, d._domPrefixes = k, d._cssomPrefixes = T, d.mq = O, d.hasEvent = I, d.testProp = function(e) {
                return a([e])
            }, d.testAllProps = u, d.testStyles = j, h.className = h.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (p ? " js " + N.join(" ") : ""), d
    }(this, this.document),
    function(e, t, n) {
        function i(e) {
        ...
        function l(e, n, i, r, o, l, u) {
            function f(t) {
                if (!h && s(c.readyState) && (w.r = h = 1, !m && a(), c.onload = c.onreadystatechange = null, t)) {
                    "img" != e && d(function() {
                        b.removeChild(c)
                    }, 50);
            ...
            1 === k[n] && (v = 1, k[n] = []), "object" == e ? c.data = n : (c.src = n, c.type = e), c.width = c.height = "0", c.onerror = c.onload = c.onreadystatechange = function() {
                f.call(this, v)
            }, g.splice(r, 0, w), "img" != e && (v || 2 === k[n] ? (b.insertBefore(c, y ? null : p), d(f, u)) : k[n].push(c))
        }

        function u(e, t, n, i, o) {
            return m = 0, t = t || "j", r(e) ? l("c" == t ? x : w, e, t, this.i++, n, i, o) : (g.splice(this.i++, 0, e), 1 == g.length && a()), this
        }
        ...
        S = function(e) {
            function t(e) {
                ...
                for (o = 0; i > o; o++) s = e[o].split("="), (r = E[s.shift()]) && (n = r(n, s));
            ...
            function s(e, r, o, s, a) {
                var l = t(e),
                    u = l.autoCallback;
                l.url.split(".").pop().split("?").shift(), l.bypass || (r && (r = i(r) ? r : r[e] || r[s] || r[e.split("/").pop().split("?")[0]]), l.instead ? l.instead(e, r, o, s, a) : (k[l.url] ? l.noexec = !0 : k[l.url] = 1, o.load(l.url, l.forceCSS || !l.forceJS && "css" == l.url.split(".").pop().split("?").shift() ? "c" : n, l.noexec, l.attrs, l.timeout), (i(r) || i(u)) && o.load(function() {
                    f(), r && r(l.origUrl, a, s), u && u(l.origUrl, a, s), k[l.url] = 2
                })))
            }
                    ...
                    if (e) {
                        if (r(e)) n || (u = function() {
                            ...
                            for (p in d = function() {
                                    ...
                                    return t
                                }(), e) e.hasOwnProperty(p) && (!n && !--d && (i(u) ? u = function() {
                                var e = [].slice.call(arguments);
                                f.apply(this, e), c()
                            } : u[p] = function(e) {
                                return function() {
            ...
            if (r(e)) s(e, 0, c, 0);
                ...
                for (l = 0; l < e.length; l++) u = e[l], r(u) ? s(u, 0, c, 0) : C(u) ? S(u) : Object(u) === u && a(u, c);
            else Object(e) === e && a(e, c)
        }, S.addPrefix = function(e, t) {
            E[e] = t
        }, S.addFilter = function(e) {
            T.push(e)
        }, S.errorTimeout = 1e4, null == t.readyState && t.addEventListener && (t.readyState = "loading", t.addEventListener("DOMContentLoaded", $ = function() {
            t.removeEventListener("DOMContentLoaded", $, 0), t.readyState = "complete"
        }, 0)), e.yepnope = f(), e.yepnope.executeStack = a, e.yepnope.injectJs = function(e, n, i, r, l, u) {
            var c, h, f = t.createElement("script"),
                r = r || S.errorTimeout;
            f.src = e;
            ...
            n = u ? a : n || o, f.onreadystatechange = f.onload = function() {
                ...
                c || (c = 1, n(1))
            }, r), l ? f.onload() : p.parentNode.insertBefore(f, p)
